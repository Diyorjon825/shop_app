...
class ManualInfoWidget extends StatefulWidget {
  static const id = 'buy_page';
  Plants info;
  ManualInfoWidget({Key? key, required this.info}) : super(key: key);
  @override
  _ManualInfoWidgetState createState() => _ManualInfoWidgetState();
}

class _ManualInfoWidgetState extends State<ManualInfoWidget> {
  @override
